...
namespace BoDi
{
  public class ObjectContainer : IObjectContainer
  {
    ...
    IContainer CreateFlexDiContainer(ObjectContainer parent)
    {
      if(parent != null)
    ...
    IContainer GetFlexDiContainer(ObjectContainer parent)
    {
      var output = CreateFlexDiContainer(parent);
    ...
    public ObjectContainer(IObjectContainer baseContainer = null) 
    {
      ...
      container = GetFlexDiContainer(parent);
